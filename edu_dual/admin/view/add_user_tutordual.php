...
-->
    <div class="container container-form">
        <h5 class="text-center">Registrar Cuenta de Usuario para Tut@r Acad&eacute;mico</h5><br>
        <form id="userForm" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="apellidos"><b>Apellidos:</b></b></label>
					<input type="text" class="form-control text-uppercase" id="idperfil" name="idperfil" placeholder="idperfil" value="7" hidden> <!-- el 7 es el id del perfil de tutor academico-->
...
var url = "send_mailregistro.php?apellidos=" + encodeURIComponent(apellidos) +
		  ...
		  "&perfil=" + encodeURIComponent("TUTOR ACADEMICO");
		  //alert(url);
		  var formDataAccount = {
                    apellidos: apellidos,
    ...
    success: function(response) {
        ...
        Swal.fire({
            ...
            if (res.success) {
                ...
                // Redireccionar al archivo
                window.location.href = "formcat_tutoresdual.php";
            }
        });
    },
    error: function(jqXHR, textStatus, errorThrown) {
        ...
        success: function(data) {
            ...
            setTimeout(function() {
                select.find('option').each(function() {
                    if ($(this).text().trim() === 'TUTOR ACADEMICO') { // PERFIL A SELECCIONAR
