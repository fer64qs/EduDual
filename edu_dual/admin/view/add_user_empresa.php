...
-->
<div class="container container-form">
        <h5 class="text-center">Registrar Cuenta de Usuario para Empresa</h5><br>
        <form id="userForm" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="apellidos"><b>Representante:</b></b></label>
					<input type="text" class="form-control text-uppercase" id="idperfil" name="idperfil" placeholder="idperfil" value="6" hidden> 
                    <input type="text" class="form-control text-uppercase" id="apellidos" name="apellidos" placeholder="APELLIDOS" value="<?php echo $representante; ?>" required >
                </div>
                <div class="form-group col-md-6">
                    <label for="nombres"><b>Nombre_empresa:</b></label>
                    <input type="text" class="form-control text-uppercase" id="nombres" name="nombres" placeholder="NOMBRE" value="<?php echo $nombre_empresa;?>" required >
                </div>
            </div>
        ...
        <div class="input-group">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control text-uppercase" id="telefono" name="telefono" placeholder="TELEFONO" value="<?php echo $telefono;?>" required >
                </div>
                <div class="form-group col-md-6">
    ...
    success: function(response) {
        ...
        Swal.fire({
            ...
            if (res.success) {
                ...
                // Redireccionar al archivo
                window.location.href = "formcat_empresas.php";
            }
        });
    },
    error: function(jqXHR, textStatus, errorThrown) {
        ...
        success: function(data) {
            ...
            setTimeout(function() {
                select.find('option').each(function() {
                    if ($(this).text().trim() === 'INSTRUCTOR DUAL') { // PERFIL A SELECCIONAR
