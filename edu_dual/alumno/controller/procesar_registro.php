...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	*/
    $existingUser = $member->getUserByClaveSIEOrEmail($clave_sie, $email, $idperfil_USR);

    if ($existingUser) {
        echo json_encode(["status" => "error", "message" => "El usuario con esa clave SIE, correo electrónico o Perfil ya existe."]);
        exit;
    }
